...
def get_answer():
    ...
    return render_template("index.html", answer=prediction, book_list=json.dumps(get_books_files()), book_text_list=json.dumps(get_books_texts())), send_file("./tts/0_20180505_deepvoice3_checkpoint_step000640000.wav", mimetype="audio/wav", as_attachment=True, attachment_filename="0_20180505_deepvoice3_checkpoint_step000640000.wav")
