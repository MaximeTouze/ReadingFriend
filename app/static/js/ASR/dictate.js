(function(window){
	...
	// Defaults
	var SERVER = "ws://lst-demo:8888/client/ws/speech";
	var SERVER_STATUS = "ws://lst-demo:8888/client/ws/status";
	var REFERENCE_HANDLER = "http://lst-demo:8888/dynamic/reference";
	...
	var Dictate = function(cfg) {
		...
		config.recorderWorkerPath = /*config.recorderWorkerPath || RECORDER_WORKER_PATH*/'js/ASR/recorderWorker.js';
